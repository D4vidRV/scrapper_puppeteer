...
const executeScraper = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const subastas = {
        Sancarleña: "http://www.aurora-applnx.com/aurora_clientes/subastas/preciosViewHistorico.php?c=1",
    ...
    for (const key in subastas) {
        ...
        try {
            ...
            const tablaFilas = yield page.$x("//table//tr");
